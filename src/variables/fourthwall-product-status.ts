...
export const FourthwallProductStatusVariable: ReplaceVariable = {
    definition: {
        handle: `${VARIABLE_PREFIX}ProductStatus`,
        description: "The status of the Fourthwall product.",
    ...
    evaluator: async (trigger) => {
        return (trigger.metadata?.eventData as FourthwallProductEventData)?.productStatus;
    }
};